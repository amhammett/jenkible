...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ...
        self.cache_path_cache = cache_dir + "/ansible-ec2.cache." + os.getenv('AWS_PROFILE', 'default')
        self.cache_path_index = cache_dir + "/ansible-ec2.index." + os.getenv('AWS_PROFILE', 'default')
    ...
    def add_instance(self, instance, region):
        ...
        # Inventory: Group by tag service
        if self.group_by_tag_service:
            try:
                tag_env = instance.tags['Environment']
                tag_service = instance.tags['Service']
                tag_role = instance.tags['Role']

                key = self.to_safe("dyn_" + tag_service + "_" + tag_env + "_" + tag_role)
                self.push(self.inventory, key, dest)
            except:
                pass
